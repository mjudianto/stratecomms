    ...
    return (
      <React.Fragment>
        ...
        <div className={styles.bghome}> 
          <div class="container">
            <div class="row" className={styles.jarak}>
                <h4>Selamat datang di <img src={Logo} alt={Logo} style={{marginBottom:'0.5%'}} width="260vw" height="33vh"/></h4>
                <p><img src={Logo} alt={Logo} style={{marginBottom:'0.4%'}} width="125vw" height="16vh"/> adalah Lembaga Pelatihan Keahlian yang membimbing calon peserta uji kompetisi PR (Public Relations)
        ...
        <div className={styles.enter}>
          <div class="container">
            <h4 className={styles.enter}>Apa itu <img src={Logo} alt={Logo} style={{marginBottom:'0.5%'}} width="260vw" height="33vh"/> ?</h4>
            <p> <img src={Logo} alt={Logo} style={{marginBottom:'0.3%'}} width="120vw" height="15vh"/> adalah lembaga yang mempersiapkan para calon peserta uji kompetensi PR (Public Relations) sebelum melaksanakan
              uji kompetensi dari Lembaga Sertifikasi Profesi Public Relations Indonesia (LSP PRI) atas nama Badan Nasional 
              Sertifikasi Profesi (BNSP). <img src={Logo} alt={Logo} style={{marginBottom:'0.3%'}} width="120vw" height="15vh"/> mendaftarkan para calon peserta pada 
              LSP PRI untuk mengikuti uji kompetensi PR.
            </p>

            
            <h4 className={styles.enter} >Pimpinan <img src={Logo} alt={Logo} style={{marginBottom:'0.5%'}} width="260vw" height="33vh"/></h4>
            <img src={Leader} alt={Leader} style={{marginTop:'2%'}} class="rounded mx-auto d-block"width="700vw" height="400vh"/>
            <p style={{marginBottom:'2%'}}>Dr. Muhammad Adi Pribadi S.E.,M.IB.,M.Com.,C.PR</p>
            <p>
              Dr. Muhammad Adi Pribadi adalah pimpinan <img src={Logo} alt={Logo} style={{marginBottom:'0.3%'}} width="120vw" height="15vh"/> yang berperan sebagai pembimbing teknis persiapan sertifikasi profesi kepada calon peserta uji kompetensi. Beliau adalah asesor aktif di LSP PRI
